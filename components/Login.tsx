...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0B0C10] flex flex-col items-center justify-center p-6 text-[#E5E7EB]">
      <div className="w-full max-w-md bg-[#16181D] border border-[#2A2D33] rounded-2xl shadow-2xl p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Statement Generator</h1>
          <p className="text-gray-500 text-sm mt-1">Sign in to access your account</p>
        </div>

        <form onSubmit={handleLogin} className="space-y-5">
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#A1A5B0] uppercase tracking-wide ml-1">Email Address</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#0B0C10] border border-[#2A2D33] text-white rounded-lg py-3 pl-10 pr-4 text-sm outline-none focus:border-[#14F1E1] focus:ring-1 focus:ring-[#14F1E1] transition-all placeholder-gray-600"
          ...
          <div className="space-y-1">
            <label className="text-xs font-bold text-[#A1A5B0] uppercase tracking-wide ml-1">Password</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      <p className="mt-8 text-[#A1A5B0] text-xs">
